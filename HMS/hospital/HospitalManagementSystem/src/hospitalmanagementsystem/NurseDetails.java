 ...
 */
public class NurseDetails extends AbstractTableModel{
    private static final String[] COLUMN_NAMES ={"Nurse ID","First Name", "Last Name", "Gender", "Contact Number"};   //coloum names of basic details 
    private static ArrayList<Employee>  list;
    
    NurseDetails(ArrayList<Employee> nrList){
        list = nrList; 
    }
