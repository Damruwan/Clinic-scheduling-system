 ...
 */
public class DoctorDetails extends AbstractTableModel {
    
    private static final String[] COLUMN_NAMES ={"Doc ID","First Name", "Last Name", "Gender", "Contact Number"};  //coloum names of basic details 
    private static ArrayList<Employee>  list;
    
    DoctorDetails(ArrayList<Employee> dtList){
        list = dtList; 
    }
