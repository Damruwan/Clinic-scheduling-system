...
public class NewEmployee extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        SubmitEmployeeDetails = new javax.swing.JButton();
        ...
        SubmitEmployeeDetails.setText("SUBMIT");
        SubmitEmployeeDetails.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                SubmitEmployeeDetailsActionPerformed(evt);
            }
        });
        ...
        jLabel10.setText("ADD A EMPLOYEE");
                ...
                .addGroup(patient_ageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, patient_ageLayout.createSequentialGroup()
                        .addGroup(patient_ageLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(patient_ageLayout.createSequentialGroup()
                                .addGap(0, 0, Short.MAX_VALUE)
                                .addComponent(SubmitEmployeeDetails, javax.swing.GroupLayout.PREFERRED_SIZE, 105, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(patient_ageLayout.createSequentialGroup()
        ...
        patient_ageLayout.setVerticalGroup(
            ...
            .addGroup(patient_ageLayout.createSequentialGroup()
                ...
                .addComponent(SubmitEmployeeDetails, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22))
        );
    ...
    private void SubmitEmployeeDetailsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SubmitEmployeeDetailsActionPerformed
       ...
       while(x==0){  
        ...
        String s4=g.getText();
        String s5=l.getText();
        if(s1.isEmpty()){JOptionPane.showMessageDialog(this, "Please Enter Employee ID");break;}else{E.setEmpID(s1);}
        if(s2.isEmpty()){JOptionPane.showMessageDialog(this, "Please Enter Employee First Name");break;}else{E.setFirstName(s2);}
        if(s3.isEmpty()){JOptionPane.showMessageDialog(this, "Please Enter Employee Address");break;}else{E.setAddress(s3);}
        if(s4.isEmpty()){JOptionPane.showMessageDialog(this, "Please Enter Employee Contact Number");break;}else{E.setContactNumber(new Integer(s4).intValue());}
        if(s5.isEmpty()){JOptionPane.showMessageDialog(this, "Please Enter Employee Age");break;}else{E.setAge(new Integer(s5).intValue());  }
    ...
    }//GEN-LAST:event_SubmitEmployeeDetailsActionPerformed
    ...
    private javax.swing.JButton SubmitEmployeeDetails;
